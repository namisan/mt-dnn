    ...
    for feature in features:
        if feature['uid'] not in exits_dict:
            ...
            if is_v2 and 'label' in feature:
                answers[feature['uid']]['is_impossible'] = True if feature['label'] else False
            exits_dict.add(feature['uid'])
    return answers
...
def postprocess_qa_predictions(
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        for feature_index in feature_indices:
            ...
            feature_null_score = start_logits[null_ans_index] + end_logits[null_ans_index]
        ...
        if not version_2_with_negative:
            ...
            if predictions:
                ...
                scores_diff_json[example["uid"]] = float(score_diff)  # To be JSON-serializable.
