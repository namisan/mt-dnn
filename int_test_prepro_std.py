...
ROBERTA_CMD = "python prepro_std.py --model roberta-large --roberta_path mt_dnn_models/roberta --root_dir %s --task_def %s --do_lower_case "
...
test_prepro_std(ROBERTA_CMD,
                SRC_DIR,
                TASK_DEF_PATH,
                "int_test_data/glue/input/prepro_std/roberta_large_cased_lower",
                "int_test_data/glue/expected/prepro_std/roberta_large_cased_lower"
                )