...
# import torch.nn.LayerNorm as T5LayerNorm
...
_CONFIG_FOR_DOC = "MSRT5Config"
_TOKENIZER_FOR_DOC = "MSRT5Tokenizer"
_CHECKPOINT_FOR_DOC = "MSRT5-small"
...
class MSRT5PreTrainedModel(PreTrainedModel):
    """
    An abstract class to handle weights initialization and a simple interface for downloading and loading pretrained
    models.
    """

    config_class = MSRT5Config
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, (MSRT5Model, MSRT5ForConditionalGeneration, MSRT5EncoderModel)):
...
class MSRT5Stack(MSRT5PreTrainedModel):
...
class MSRT5Model(MSRT5PreTrainedModel):
    ...
    def __init__(self, config: MSRT5Config):
        ...
        self.encoder = MSRT5Stack(encoder_config, self.shared)

        decoder_config = copy.deepcopy(config)
        decoder_config.is_decoder = True
        decoder_config.is_encoder_decoder = False
        decoder_config.num_layers = config.num_decoder_layers
        self.decoder = MSRT5Stack(decoder_config, self.shared)
...
class MSRT5ForConditionalGeneration(MSRT5PreTrainedModel):
    _keys_to_ignore_on_load_missing = [
        r"encoder.embed_tokens.weight",
        r"decoder.embed_tokens.weight",
        r"lm_head.weight",
    ...
    def __init__(self, config: MSRT5Config):
        ...
        self.decoder = MSRT5Stack(decoder_config, self.shared)
        # 
        # self.output_projection = RobertaLMHead(
...
class MSRT5EncoderModel(MSRT5PreTrainedModel):
